...
INPUT_CHANNELS = 4
discriminator_x = pix2pix.discriminator(norm_type='instancenorm', INPUT_CHANNELS=INPUT_CHANNELS, target=False, ch=2)
discriminator_y = pix2pix.discriminator(norm_type='instancenorm', INPUT_CHANNELS=INPUT_CHANNELS, target=False, ch=2)
...
#from the Algo.1 (p4) in https://proceedings.neurips.cc/paper/2017/file/892c3b1c6dccd52936e27cbd0ff683d6-Paper.pdf
  with tf.GradientTape(persistent=True) as tape:
    ...
    for i in range(n_critic):
      ...
      disc_x_loss =  disc_x_normal+ GP_LAMBDA*disc_x_wassgp
      ...
      disc_y_loss = disc_y_normal + GP_LAMBDA*disc_y_wassgp
  ...
  return [gen_g_loss, total_cycle_loss, identity_loss_real_y_same_y, gen_g_sem, total_gen_g_loss,
          gen_f_loss, total_cycle_loss, identity_loss_real_x_same_x, gen_f_sem, total_gen_f_loss,
